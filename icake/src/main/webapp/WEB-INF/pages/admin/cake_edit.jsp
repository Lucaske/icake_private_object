                    ...
                    <form method="post" action="/admin/Cake/add.do" enctype="multipart/form-data" id="admin-form">
                        ...
                        <div class="panel-body bg-light">
                            <div class="section row">
                                ...
                                <div class="col-md-5">
                                    <label for="title" class="field prepend-icon">
                                        <input type="text" name="title" id="title" class="gui-input" placeholder="名称..." required value="${cake.title}">
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-7">
                                    <input type="hidden" name="image_path" value="${cake.image_path}">
                                    ...
                                    <label class="field select">
                                        <select id="language" name="cid">
                                            <c:forEach var="cat1" items="${root.children}">
                                                <c:forEach var="cat2" items="${cat1.children}">
                                                    <c:forEach var="cat3" items="${cat2.children}">
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-8">
                                    <label for="material" class="field prepend-icon">
                                        <input type="text" name="material" value="${cake.metarial}" id="material" class="gui-input" placeholder="材料..." required>
